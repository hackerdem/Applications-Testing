...
query1={
    ...
    attachments:"",
    dateIdentified:"2017-08-06",
    personReporting:"same number test",
    overview:"same number test",
    category:"Health and Safety Consultation",
    dateDue:"2017-09-19",
    personResponsible:"d",
    personResponsibleEmail:"demo1@g.com",
    description:"test for creating action with same number"
}.to_json
...
50.times do
    pool.perform do
        req1 = RestClient::Request.execute(
            method: :POST,
            url:'http://54.252.241.122:8000/actions/new',
